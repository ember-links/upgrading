...
## Upgrading to Ember 2.9.1

I had already updated Ember to 10 for Glimmer 2, so bear that in mind in this update (ignoring the Ember package update).

Taken from the [official release](https://github.com/ember-cli/ember-cli/releases/tag/v2.9.1)
...
- `rm -rf node_modules bower_components dist tmp`
- `npm install ember-cli@2.9.1 --save-dev`
- `npm install`
- `bower install`
